...
const Cooking = ({ cookingQue, setCookingQue }) => {
  const likeHandler = (questionId) => {
    setCookingQue((prevQueAns) => {
  ...
  const deleteHandler = (id) => {
    const queAnsFilter = cookingQue?.filter((item) => item.id !== id);
    setCookingQue(queAnsFilter);
  };
