...
const Sidebar = () => {
  ...
  return (
    <div className="sidebarOptions">
      ...
      <div className="sidebarOption" onClick={historyPage}>
        <img
      ...
      <div className="sidebarOption" onClick={cookingPage}>
        <img
      ...
      <div className="sidebarOption" onClick={musicPage}>
        <img
      ...
      <div className="sidebarOption" onClick={sciencePage}>
        <img
      ...
      <div className="sidebarOption" onClick={healthPage}>
        <img
      ...
      <div className="sidebarOption" onClick={moviesPage}>
        <img
